const en = {
  ...
  "MigrateFourPlayersSaveDesc1": "You can migrate the game's save files to the palserver GUI.",
  "MigrateFourPlayersSaveDesc2": "After entering the game, click 'Start Game', select the save file to migrate, click the file icon in the lower left corner, and copy all files except WorldOption.sav.",
  "MigrateFourPlayersSaveDesc3": "Click 'Open Save Data Folder' in the lower right corner.",
  "MigrateFourPlayersSaveDesc4": "Paste the content just copied (if necessary, choose to replace all).",
  "MigrateFourPlayersSaveDesc5": "Start the server, click 'Join Multiplayer Game (Start Game)' in the game to enter the server and play for a while before closing. Pay attention to the extra files in the Players folder in the save data folder.",
  "MigrateFourPlayersSaveDesc6": "Go to the Python official website to set up the environment, and make sure to click 'add python.exe to PATH' during the download process.",
  "MigrateFourPlayersSaveDesc7": "Download the conversion tool from https://github.com/xNul/palworld-host-save-fix/archive/refs/heads/main.zip, unzip it, open the terminal/command prompt (cmd) in that path, and enter pip install palworld-save-tools==0.17.1.",
  "MigrateFourPlayersSaveDesc8": "In the terminal/command prompt, enter python fix-host-save.py 'Enter the save file path here (open the save data folder in the lower right corner)' 'Enter the file name(s) extra in the Players folder here (ignore .sav)' 00000000000000000000000000000001 True (enter False if the guild does not need to be retained) and press Enter twice.",
  "MigrateFourPlayersSaveDesc9": "Wait for the Python script to finish executing, then start the server.",
