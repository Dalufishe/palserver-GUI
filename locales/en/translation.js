...
const en = {
  ...
  KickPlayer: 'Kick',
  KickPlayerDesc:
    'Are you sure you want to kick ${1} (${2})? This action will remove ${3} from the server.',
  ConfirmKick: ' Confirm Kick',
  Ban: 'Ban',
  BanDesc:
    'Are you sure you want to ban ${1} (${2})? This action will remove ${3} from the server and the user will not be able to rejoin until unbanned.',
