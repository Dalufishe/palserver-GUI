...
YouselfEnterIP: 'Il s agit de l adresse IP saisie par vous-même',
  ...
  UpdateServerToLatestVersion: 'Mettre à jour le serveur vers la dernière version',
  ...
  PalAutoHpRegeneRateInSleep: 'Taux de régénération automatique des PV de Pal en veille',
  ...
  PlayerAutoHpRegeneRateInSleep: 'Taux de régénération automatique des PV du joueur en veille',
  BuildObjectDamageRate: ' le taux de dégâts des objets Construction',
  BuildObjectDeteriorationDamageRate: 'Taux de détérioration des objets de construction',
  ...
  CollectionObjectRespawnSpeedRate: 'Vitesse de réapparition des objets de collection',
  ...
  bAutoResetGuildNoOnlinePlayers: 'Réinitialisation automatique de la guilde sans joueurs en ligne',
  ...
  bIsStartLocationSelectByMap: 'Démarrer la sélection de l emplacement en fonction de la carte',
  bExistPlayerAfterLogout:
    'Le joueur existant après la déconnexion ferme automatiquement le serveur',
  bEnableDefenseOtherGuildPlayer: 'Activer la défense des autres joueurs de la guilde',
  ...
  MigrateDedicatedServerToGUI: 'Migrer un serveur dédié vers une interface graphique',
  ...
  MigrateFourPlayersSaveToGUI: 'Migrer la sauvegarde locale vers l interface graphique',
...
Ouvert : 'Ouvrir',
  ...
  NoServer: 'Aucun serveur disponible, veuillez faire un clic droit pour ajouter ou importer.',
  ...
  AutoRestartDesc: 'Redémarrez le serveur périodiquement. Rcon doit être activé.',
  ...
  OverRamRestartDesc: 'Redémarrez le serveur lorsque l’utilisation de la mémoire dépasse 90 %.',
  All: 'Tout',
  ...
  OnlineMapDesc: 'Affichez les emplacements des joueurs dent le jeux (en ligne en temps réel.)',
